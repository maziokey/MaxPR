...
class ContactForm(forms.Form):
    name = forms.CharField(required=True, label='Name', widget=forms.TextInput(attrs={'placeholder': 'Name'}))
    email = forms.EmailField(required=True, label='Email', widget=forms.TextInput(attrs={'placeholder': 'Email'}))
    company = forms.CharField(required=True, label='Company Name', widget=forms.TextInput(attrs={'placeholder': 'Company'}))
